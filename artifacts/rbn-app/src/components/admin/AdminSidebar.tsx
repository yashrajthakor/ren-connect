...
import { LayoutDashboard, FileText, Users, ShieldCheck, Handshake, Megaphone, MessageCircleQuestion, Newspaper, Tags, Pin, Star } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const baseItems: Item[] = [
  ...
  { title: "Sponsor Highlights", url: "/admin/sponsors", icon: Star },
];
