    ...
    return (
      <div className="max-w-3xl mx-auto px-4 py-24 text-center">
        ...
        <Button asChild variant="royal">
          <Link to="/dashboard/news">Back to all stories</Link>
        </Button>
      </div>
    );
  }
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {related.length > 0 && (
          <section className="bg-muted/40 border-t border-border mt-12 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-12">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
                {related.map((r) => (
                  <Link key={r.id} to={`/dashboard/news/${r.slug}`} className="group">
