-- Add a "Top Referral Givers" leaderboard (top 5 members by number of leads
-- shared as the giver, excluding direct-business/appreciation records) to
-- the admin dashboard stats RPC.
